...
class DictionaryApi {
  ...
  Future<List<Dictionary>> getWordByTopic(String topic) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception(
          'Failed to load words for topic "$topic": ${response.statusCode}',
        );
      }
    } catch (e) {
  ...
  Future<Map<String, List<Dictionary>>> getYourDictionary() async {
    try {
      final url = Uri.parse('$baseUrl/getYourDictionary');
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception(
          'Failed to load your dictionary: ${response.statusCode}',
        );
      }
    } catch (e) {
      throw Exception('Error fetching your dictionary: $e');
    }
  }
}