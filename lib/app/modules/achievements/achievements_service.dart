  ...
  Future<List<Achievement>> getAchievements() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonData is! List) {
          _logger.e('Định dạng dữ liệu không hợp lệ: Dự kiến là danh sách thành tựu, nhận được: $jsonData');
          throw Exception('Invalid data format: Expected a list of achievements');
        }
        _logger.i('Đã phân tích thành công ${jsonData.length} thành tựu');
