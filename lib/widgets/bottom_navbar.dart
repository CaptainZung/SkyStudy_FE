...
class CustomBottomNavBar extends StatelessWidget {
  ...
  void _onItemTapped(BuildContext context, int index) {
    ...
    // Debounce để tránh điều hướng quá nhanh
    Future.delayed(const Duration(milliseconds: 100), () {
      if (!context.mounted) return;

      // Điều hướng với các route đã định nghĩa trong MaterialApp
      switch (index) {
        case 0:
        ...
        children: List.generate(icons.length, (index) {
          return Material(
            ...
            child: InkWell(
              ...
              // Xóa splashColor và highlightColor để bỏ hiệu ứng lan tỏa
              child: Container(
